...
\newcommand{\CourseName}{ФПМИ}
\newcommand{\FullCourseNameFirstPart}{\so{Физтех-школа Прикладной Математики и Информатики}}
\newcommand{\SemesterNumber}{IV}
\newcommand{\LecturerInitials}{Иван Иванович Иванов}
\newcommand{\CourseDate}{осень 2022}
\newcommand{\AuthorInitials}{Киселев Никита}
\newcommand{\VKLink}{https://vk.com/kisnikser}
\newcommand{\GithubLink}{https://github.com/nekitbrain}
...
%%% МОУ
\newcommand{\ndef}{\stackrel{\mathrm{def}}{\Leftrightarrow}}
...
\usepackage{dsfont}
\newcommand{\pr}[1]{\mathds{P}(#1)}
\newcommand{\ex}[1]{\mathds{E}(#1)}
